...
struct noteIdStruct{
    ...
    init(_ title:String,_ note:String,_ id:String) {
        self.title = title
        self.note = note
        self.id = id
    }
...
class GetData {
    ...
    static var shouldRetrieveData = true
    ...
    static var noteIdList = [noteIdStruct]()
    ...
    static func writeToJsonFile(data inventory:Inventory) -> Bool{
        ...
        let filepath = "/Users/admin/Desktop/testing/BridgeLabz/week10_1/FundooNotes/loginRegisterPortal/login.json"
    ...
    static func readFromJsonFile(){
        let filePath = "/Users/admin/Desktop/testing/BridgeLabz/week10_1/FundooNotes/loginRegisterPortal/login.json"  // file path
        let fileData = FileManager.default.contents(atPath: filePath)
        let decoder = JSONDecoder()
        do{
