...
extension EditNote  {
    ...
    func archiveNote(){
        ...
        GetData.arrayOfArchivedNotes.append(oneNote(noteTitle.text!,note.text,GetData.colorOfNoteToBeEdited,numberOfArchivedNotes,archived,markedImportant,reminderDateTimeInfo))
    ...
    func unArchiveTheArchivedNote(){
        ...
        numberOfNotes += 1
        GetData.localArrayOfNotes.append(oneNote(noteTitle.text!,note.text,GetData.colorOfNoteToBeEdited,numberOfNotes,archived,markedImportant,reminderDateTimeInfo))
