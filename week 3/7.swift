...
//        let returnSymbol = tail?.stockSymbol
//        let returnTransaction = tail?.transactionDone
//        tail = tail?.previous
//        if(tail != nil)
//        {
//            tail!.next = nil
//        }
//
//        let returnTuple = (returnSymbol,returnTransaction)
//        return returnTuple as! (String, String)
//    }
...
public class StockAccount {
    ...
    func printReport() {
        ...
        while stackPointer.previous != nil {
            print("\(stackPointer.stockSymbol ?? defaultString) \(stackPointer.transactionDone ?? defaultString)")
